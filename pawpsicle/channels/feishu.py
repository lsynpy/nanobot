...
from pawpsicle.channels.base import BaseChannel
from pawpsicle.config.schema import FeishuConfig
...
class FeishuChannel(BaseChannel):
    ...
    async def _download_and_save_media(
        ...
        loop = asyncio.get_running_loop()
        media_dir = Path.home() / ".pawpsicle" / "media"
    ...
    async def _on_message(self, data: "P2ImMessageReceiveV1") -> None:
        try:
            ...
            sender_id = (sender.sender_id.open_id or "unknown") if sender.sender_id else "unknown"
